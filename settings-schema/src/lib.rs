...
/// GUI type associated to a choice node or choice higher-order setting.
#[derive(Serialize, Deserialize, Clone, Debug)]
...
#[serde(tag = "type", content = "content")]
pub enum SchemaNode {
    Section(Vec<(String, Option<EntryType>)>),
